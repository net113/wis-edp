...
class Dashboard extends CI_Controller
{
    ...
    public function getToko()
    {
        ...
        FROM tb_toko LEFT JOIN tb_user ON tb_toko.`pic_maintenance`=tb_user.`username` LEFT JOIN tb_astinet ON tb_toko.`KodeToko`= tb_astinet.kdtk  JOIN master_ip ON tb_toko.`KodeToko`=master_ip.`kdtk` WHERE tb_toko.Kodetoko='$kdtk'";
