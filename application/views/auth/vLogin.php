                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h2 class="h4 text-gray-900 ">Web Base Information Sharing EDP</h2>
                                ...
                                <form class="user" method="post" action="<?= base_url('auth') ?>">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="pasword" name="password" placeholder="Password..." value="<?= set_value('email'); ?>">
