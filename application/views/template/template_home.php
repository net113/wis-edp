    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">EDP BOGOR</div>
            </a>
            ...
            $menu = $this->db->query('SELECT tb_menu.*,id_level_user FROM tb_menu
             JOIN tb_menu_role ON tb_menu.id=tb_menu_role.id_menu WHERE  is_main_menu=0 and 
             id_level_user=' . $role_id . ' ORDER BY urutan_menu')->result_array();

            foreach ($menu as $m) :  ?>

                <?php
                $submenu = $this->db->query('SELECT tb_menu.*,id_level_user FROM tb_menu
            ...
            id_level_user=' . $role_id . ' ORDER BY urutan_menu')->result_array();
                ...
                <li class="nav-item">
                    ...
                    ?>
                    <!-- Nav Item - Dashboard -->
                    <li <?php echo ($title_page == $m['nama_menu']) ? 'class="nav-item active"' : 'class="nav-item"'; ?>>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= getFullname(); ?></span>
                                <img class="img-profile rounded-circle" src="<?= base_url('assets/img/profile/') . getPictProfile(); ?>">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Ramdan Permadi <?= date('Y') ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
